...
export const Default: Story = {
  args: {
    ...
    category: 'フロントエンド',
    imageUrl:
      'https://images.unsplash.com/photo-1633356122544-f134324a6cee?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200&q=80',
...
export const LongTitle: Story = {
  args: {
    title:
      'とても長いタイトルの記事：モダンなWebアプリケーション開発における設計パターンとアーキテクチャの選択について',
    category: 'アーキテクチャ',
    imageUrl:
      'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200&q=80',
    href: '/articles/web-app-architecture',
    description:
      'モダンなWebアプリケーション開発で重要な設計パターンとアーキテクチャの選択について、実際のプロジェクト経験を基に解説します。',
...
export const NoDescription: Story = {
  args: {
    ...
    category: 'シンプル',
    imageUrl:
      'https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200&q=80',
...
export const CustomClassName: Story = {
  args: {
    ...
    category: 'デザイン',
    imageUrl:
      'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200&q=80',
...
export const HorizontalLayout: Story = {
  args: {
    ...
    description:
      '画像とテキストが横並びで表示される記事カードのレイアウトです。コンパクトな表示に適しています。',
    layout: 'horizontal',
    aspectRatio: 1,
    categoryVariant: 'outline',
  },
