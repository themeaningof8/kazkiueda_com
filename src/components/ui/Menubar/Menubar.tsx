...
const MenubarPortal = React.memo(
...
const MenubarShortcut = React.memo(({ className, ...props }: React.ComponentProps<'span'>) => {
  return (
    <span
...
const MenubarSub = React.memo(({ ...props }: React.ComponentProps<typeof MenubarPrimitive.Sub>) => {
