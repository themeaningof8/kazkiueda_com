    ...
    <div className='max-w-4xl mx-auto'>
      ...
      <div className='prose prose-gray dark:prose-invert max-w-none'>
        ...
        <ul className='space-y-2 text-muted-foreground'>
          <li>
            • <strong>React 19</strong> - UIライブラリ
          </li>
          <li>
            • <strong>TypeScript</strong> - 型安全性
          </li>
          <li>
            • <strong>React Router</strong> - ルーティング
          </li>
          <li>
            • <strong>TailwindCSS</strong> - ユーティリティファーストCSS
          </li>
          <li>
            • <strong>Vite</strong> - 高速ビルドツール
          </li>
          <li>
            • <strong>Bun</strong> - 高速パッケージマネージャー
          </li>
          <li>
            • <strong>oxlint</strong> - 高速リンター
          </li>
          <li>
            • <strong>Storybook</strong> - コンポーネント開発環境
          </li>
        </ul>
