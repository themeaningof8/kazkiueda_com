...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE INDEX "_status_publishedDate_idx" ON "posts" USING btree ("_status","published_date");
  ...
  CREATE INDEX "version__status_version_publishedDate_idx" ON "_posts_v" USING btree ("version__status","version_published_date");
