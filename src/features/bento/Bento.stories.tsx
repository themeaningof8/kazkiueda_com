...
import { HoverCard, HoverCardContent, HoverCardTrigger } from '@/components/ui/HoverCard/HoverCard'
...
const ErrorComponent = ({ shouldError }: { shouldError: boolean }) => {
  ...
  return (
    <p className='text-sm text-center text-muted-foreground'>Component rendered successfully.</p>
  )
}
  ...
  args: {
    children: (
      <React.Fragment>
        ...
        <BentoCard title='Input OTP' className='md:col-span-2'>
        ...
        <BentoCard title='Switch & Checkbox' className='md:col-span-2'>
          <div className='flex items-center space-x-2'>
