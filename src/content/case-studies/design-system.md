...
実装時のデザイナー間の「意匠の好み」に関する議論が減り、リポジトリに亜種コンポーネントが増殖する前にレビューで指摘できるようになった。チーム全体で実装の細かい話ではなく体験や仕様の議論に集中できるようになった。

一番大きかった変化は、デザイナー以外がFigmaにあるデザインデータを使い始めたことだ。これにより施策立案をこのデザインデータを基に行うようになった。

残念ながら事業の売却によって1年足らずの運用で他社に承継されていったが、金融側のデザインシステムでの問題はあらかた解決されたように思う。ですが一番大変なのは、メンバーに使ってもらう、ルールを守ってもらう、フィードバックをもらうことだと思う。作った後のデザイン・リーダーシップもデザインシステムが浸透するかの鍵であると思いました。